...
const GuideBanner = (props) => {
  ...
  return (
    <div
      className='cebapp-banner-component-guide ng-tns-c13-33 height-medium ng-star-inserted'
      style={{
        width: '100%',
        ...
        <div className='content left design-b'>
          <div className='content-wrap left'>
            <span className='country text-blue'>
              <h1>
                <strong>{block.parameters.title}</strong>
              </h1>
            </span>
          ...
          <a
            className='o-btn fixed-size o-btn--primary-blue'
            href='{block.parameters.buttonLink}'
            target='_self'
          >
