...
const ButtonTextInputField = (props) => {
  ...
  return (
    ...
    >
      ...
      <div
        id='button_text_input_field_component'
        className='button-text-input-field-component'
        style={{
      ...
      >
        <input
          type={block.parameters.input_type}
        ...
        >
          <svg
            style={{ fill: block.parameters.button_color }}
